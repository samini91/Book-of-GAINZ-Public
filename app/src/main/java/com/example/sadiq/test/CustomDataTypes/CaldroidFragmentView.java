...
public class CaldroidFragmentView extends DialogFragment {
    ...
    public void restoreDialogStatesFromKey(FragmentManager manager,
        ...
        CaldroidFragmentView existingDialog = (CaldroidFragmentView) manager
     ...
     * @return
     */
    public static CaldroidFragmentView newInstance(String dialogTitle, int month,
                                               int year) {
        CaldroidFragmentView f = new CaldroidFragmentView();
...
*/
    ...
    public class DatePageChangeListener implements OnPageChangeListener {
        ...
        private int getNext(int position) {
            return (position + 1) % CaldroidFragmentView.NUMBER_OF_PAGES;
        }
        ...
        private int getPrevious(int position) {
            return (position + 3) % CaldroidFragmentView.NUMBER_OF_PAGES;
        }
        ...
        public int getCurrent(int position) {
            return position % CaldroidFragmentView.NUMBER_OF_PAGES;
        }
        ...
        public void onPageSelected(int position) {
            ...
            CaldroidGridAdapter currentAdapter = caldroidGridAdapters
                    .get(position % CaldroidFragmentView.NUMBER_OF_PAGES);
